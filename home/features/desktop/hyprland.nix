    ...
    wayland.windowManager.hyprland = {
      ...
      settings = {
        ...
        bind = [
          ...
          ", Print, exec, f=\"$HOME/Screenshots/$(date +%Y-%m-%d_%H-%M-%S).png\"; grim -g \"$(slurp)\" \"$f\" && wl-copy < \"$f\""
          "$mainMod, Print, exec, f=\"$HOME/Screenshots/$(date +%Y-%m-%d_%H-%M-%S).png\"; grim \"$f\" && wl-copy < \"$f\""
